...
CRANE_HELM_NAME=installation
PROMETHEUS_HELM_NAME=installation
PROMETHEUS_VALUE_URL=installation/prometheus_override_values.yaml
GRAFANA_HELM_NAME=installation
GRAFANA_VALUE_URL=installation/grafana_override_values.yaml
...
helm install kube-state-metrics -n crane-system --create-namespace ${PROMETHEUS_HELM_NAME}/kube-state-metrics
